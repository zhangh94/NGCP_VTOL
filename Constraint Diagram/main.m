...
%% Parameters
% TODO: Place all constraints into separate routine functions. Or an object?
n = 50; % number of data points
WS = linspace(.25,2,n); % wingloading [lb/ft2]
...
PW = linspace(3, 16, n); % power to weight [hp/lb]
...
E = (ac.Rt).^(1-ac.n).*((ac.e_tot.*ac.V.*ac.C)./...
    ...
    - ac.C*0.25;
contour(WS,PW,repmat(E,n,1),[20/60 20/60]);
